  ...
  return (
    ...
    >
      <div className="max-w-5xl mx-auto flex h-20 items-center px-4 gap-8">
        {/* Logo & Title */}
        <Link href="/" className="flex items-center gap-2 font-bold text-2xl shrink-0 hover:opacity-80 transition-opacity">
          <div className="shrink-0 hidden md:block">
            <AtomLogo size={80} isDark={isDark} />
          </div>
          <div className="shrink-0 md:hidden">
            <AtomLogo size={64} isDark={isDark} />
          </div>
